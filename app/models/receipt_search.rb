class ReceiptSearch
  ...
  attr_accessor :receipt_number, :given_name, :family_name, :donation_date, :amount
  
  def initialize(params = {})
    @receipt_number, @given_name, @family_name, @donation_date, @amount = params[:receipt_number], params[:given_name], params[:family_name], params[:donation_date], params[:amount]
  end
end