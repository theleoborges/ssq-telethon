...
class GatewayUrlBuilderTest < ActiveSupport::TestCase
  test "something interesting" do
    ...
    begin
      ...
      expected_url = "https://gateway.com/vpcpay?vpc_AccessCode=access_code&vpc_Amount=12345&vpc_Command=pay&vpc_Locale=en&vpc_MerchTxnRef=txn1&vpc_Merchant=merchant&vpc_OrderInfo=order1&vpc_ReturnURL=http%3A%2F%2Flocalhost%3A3000%2Fgateway_callback&vpc_SecureHash=84f80a3ae85bbc0ad0b7cf957352569b&vpc_Version=1"
